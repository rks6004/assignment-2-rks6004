...
#define JBOD_NUM_BLOCKS_PER_DISK  (JBOD_TOTAL_ARRAY_SIZE/JBOD_BLOCK_SIZE)/JBOD_NUM_DISKS

#define JBOD_DISK_SIZE            65536 //JBOD_BLOCK_SIZE * JBOD_NUM_BLOCKS_PER_DISK
